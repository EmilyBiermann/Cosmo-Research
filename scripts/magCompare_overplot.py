...
points2_clip2,points2Cut2,mean2_clip2,stdev2_clip2 = \
    sigma3clip(points2_clip1,mean2_clip1,stdev2_clip1)
...
xarray2,yarray2,mode2,cmin2,cmax2 =\
     gaussFit(points2_clip2,nbins,mean2_clip2,stdev2_clip2)
# Plot Figure
plt.figure()
...
plt.hist(points2_clip2,range=[cmin2,cmax2], bins=nbins, color='r');
#plt.plot(xarray,yarray,color="red",linewidth=1.0,label='Gaussian Fit')
...
points2_clip3,points2Cut3,mean2_clip3,stdev2_clip3 = \
    sigma3clip(points2_clip2,mean2_clip2,stdev2_clip2)
...
xarray2,yarray2,mode2,cmin2,cmax2 =\
    gaussFit(points2_clip3,nbins,mean2_clip3,stdev2_clip3)
# Plot Figure
plt.figure()
plt.title(r'R-Band Magnitude Comparison with 3 Iterations of 3 Sigma Clipping')
plt.xlabel(r'WtG Mag - Crawford Mag')
plt.ylabel(r'Number of Galaxies')
plt.hist(points_clip3,range=[cmin,cmax], bins=nbins,label=r'1as Match');
plt.hist(points2_clip3,range=[cmin2,cmax2], bins=nbins, color='r',label='3as Match');
#plt.plot(xarray,yarray,color="red",linewidth=1.0,label='Gaussian Fit')
